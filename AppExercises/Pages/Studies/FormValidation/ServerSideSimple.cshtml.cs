...
namespace AppStudies.Pages
{
    ...
    public class ServerSideSimpleModel : PageModel
    {
        //Just like for WebApi
        IQuoteService _service = null;
        ILogger<ServerSideSimpleModel> _logger = null;
        ...
        public ServerSideSimpleModel(IQuoteService service, ILogger<ServerSideSimpleModel> logger)
        {
            _logger = logger;
            _service = service;
        }
